const CACHE='pbk-shell-v6';
const SHELL=['/','/index.html','/app.css','/filters.css','/install.css','/runtime.css','/push.css','/probability.css','/app.js','/filters.js','/install.js','/runtime.js','/push.js','/probability.js','/icon.svg','/manifest.webmanifest'];
