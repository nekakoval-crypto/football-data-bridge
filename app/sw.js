const CACHE='pbk-shell-v5';
const SHELL=['/','/index.html','/app.css','/filters.css','/install.css','/runtime.css','/push.css','/app.js','/filters.js','/install.js','/runtime.js','/push.js','/icon.svg','/manifest.webmanifest'];
