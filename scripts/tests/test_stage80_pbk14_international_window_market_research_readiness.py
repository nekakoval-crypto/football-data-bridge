...
class PBK14InternationalWindowMarketResearchReadinessTests(unittest.TestCase):
    def setUp(self):
    ...
    def materialize_join(self):
        ...
        self.write_json("stage80_pbk14_international_window_market_join_last_run.json",{
            ...
            "stake_changes":False,"forward_journal_mutation":False,
            "closing_1x2_matches":1,"closing_total25_matches":1,
        })

    def materialize_research(self,*,authority=False):
        profile={
            "factor":"INTL_AFTER_72H","bucket":"WITHIN","scope_type":"ALL","scope_value":"ALL",
            "matches":"1","research_only":"true",
        ...
        stability={
            "factor":"INTL_AFTER_72H","bucket":"WITHIN","scope_type":"ALL","scope_value":"ALL",
            "seasons_with_matches":"1","research_only":"true",
            "operational_betting_authority":"false","creates_signal":"false","promotes_factor":"false",
        }
        self.write_csv("pbk14_international_window_market_factor_research.csv",list(profile),[profile])
        self.write_csv("pbk14_international_window_market_factor_stability_research.csv",list(stability),[stability])
        self.write_json("stage80_pbk14_international_window_market_research_last_run.json",{
            "version":"PBK_STAGE80_PBK14_INTERNATIONAL_WINDOW_MARKET_RESEARCH_V1",
            "source_rows":1,"valid_research_rows":1,"invalid_governance_or_result_rows":0,
            "factor_names":FACTORS,"factor_profile_rows":1,"stability_rows":1,
            "closing_1x2_matches":1,"closing_total25_matches":1,
            ...
            "historical_backfill_only":True,"research_only":True,
            "operational_betting_authority":False,"creates_signal":False,
            "promotes_factor":False,"probability_mutation":False,"eligibility_mutation":False,
            "stake_changes":False,"forward_journal_mutation":False,
        })

    def test_complete_research_closes_gap(self):
        self.materialize_join()
        self.materialize_research()
        report=readiness.build_report(self.ops,archive_dir="")
        layer=report["pbk14_international_window_market_research"]
        ...
        self.assertNotIn("PBK14_INTERNATIONAL_WINDOW_MARKET_RESEARCH_NOT_MATERIALIZED",report["gaps"])
        self.assertNotIn("PBK14_INTERNATIONAL_WINDOW_MARKET_RESEARCH_INVALID",report["gaps"])

    def test_missing_research_is_explicit(self):
        self.materialize_join()
        report=readiness.build_report(self.ops,archive_dir="")
        self.assertIn("PBK14_INTERNATIONAL_WINDOW_MARKET_RESEARCH_NOT_MATERIALIZED",report["gaps"])

    def test_authority_leak_invalidates_research(self):
        self.materialize_join()
        self.materialize_research(authority=True)
        report=readiness.build_report(self.ops,archive_dir="")
        self.assertIn("PBK14_INTERNATIONAL_WINDOW_MARKET_RESEARCH_INVALID",report["gaps"])
