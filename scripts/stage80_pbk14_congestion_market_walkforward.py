#!/usr/bin/env python3
"""Stage80 — walk-forward validation for PBK14 competition-congestion factors.

Each test season is evaluated only against strictly earlier seasons. Input is the
durable AUTO/HIGH PBK14 historical market × PBK16 congestion join.
...
try:
    from stage80_pbk14_congestion_market_research import enrich, factor_buckets
except ImportError:  # pragma: no cover
    from scripts.stage80_pbk14_congestion_market_research import enrich, factor_buckets
