...
Обновлено UTC: 2026-09-18T17:23:36Z
Статус: **COLLECTING**

## Покрытие
- Fixtures в текущем inventory: 129 (finished: 1).
- Fixture history: 178 unique fixtures / 1667 observations / 13 observation runs (finished observed: 44).
- Historical fixture catalog: 178 fixtures (terminal 44, rescheduled 0), history coverage 100.00%; missing 0, orphan 0.
...
- Player xG/xA source: RESEARCH_ADAPTER_READY_NOT_MATERIALIZED.
...
- Verified PBK↔Transfermarkt identities: 0 rows / 0 PBK players; invalid 0.
...
- VERIFIED_TRANSFER_IDENTITY_NOT_MATERIALIZED
- TEAM_XG_PARTIAL_CAPTURED_FIXTURE_COVERAGE
- PLAYER_XG_XA_RESEARCH_SOURCE_NOT_MATERIALIZED
