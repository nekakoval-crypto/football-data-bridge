...
Обновлено UTC: 2026-09-14T12:08:59Z
...
## Свежесть этапов
- Stage53 screener: **OK** | age 5.55h | limit 30.0h
...
- Stage57 international: **OK** | age 5.35h | limit 30.0h
...
- Stage65 WATCH performance: **OK** | age 0.03h | limit 3.0h
- Stage66 attention board: **OK** | age 0.13h | limit 3.0h
- Stage70 lifecycle: **OK** | age 1.00h | limit 3.0h
- Stage71 challengers: **OK** | age 3.82h | limit 8.0h
...
- **CRITICAL** `MISSING_STABLE_SOURCES` — Stage72 missing=['standings_snapshots.csv']
- **WARN** `SCHEMA_VERSION` — Expected Stage72 schema v6, got 13
- **CRITICAL** `STAGE72_MISSING_STABLE_SOURCE` — Stage72 missing stable sources: standings_snapshots.csv
