...
Обновлено UTC: 2026-09-18T02:05:56Z
...
## Свежесть этапов
- Stage53 screener: **STALE** | age 43.53h | limit 30.0h
...
- Stage57 international: **OK** | age 19.31h | limit 30.0h
- Stage58 daily brief: **OK** | age 0.06h | limit 3.0h
- Stage59 user execution: **OK** | age 1.18h | limit 3.0h
...
- Stage63 BTTS watch: **OK** | age 1.73h | limit 3.0h
...
- Stage71 challengers: **STALE** | age 10.59h | limit 8.0h
...
## Проблемы
- **WARN** `STALE_STAGE` — Stage53 screener: age 43.53h > 30.00h
- **WARN** `STALE_STAGE` — Stage71 challengers: age 10.59h > 8.00h
