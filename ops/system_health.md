...
Обновлено UTC: 2026-09-24T19:06:33Z
...
- Stage63 BTTS watch: **STALE** | age 4.82h | limit 3.0h
...
- Stage71 challengers: **OK** | age 3.53h | limit 8.0h
...
## Проблемы
- **CRITICAL** `STALE_STAGE` — Stage59 user execution: age 10.19h > 3.00h
- **WARN** `STALE_STAGE` — Stage63 BTTS watch: age 4.82h > 3.00h
