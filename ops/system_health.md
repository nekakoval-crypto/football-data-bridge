...
Обновлено UTC: 2026-09-15T14:06:15Z
...
## Свежесть этапов
- Stage53 screener: **OK** | age 7.51h | limit 30.0h
...
- Stage57 international: **STALE** | age 31.30h | limit 30.0h
- Stage58 daily brief: **OK** | age 0.06h | limit 3.0h
- Stage59 user execution: **OK** | age 1.15h | limit 3.0h
...
- Stage63 BTTS watch: **OK** | age 1.76h | limit 3.0h
...
## Проблемы
- **WARN** `STALE_STAGE` — Stage57 international: age 31.30h > 30.00h
