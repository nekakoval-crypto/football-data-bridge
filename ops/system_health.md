...
Обновлено UTC: 2026-09-18T03:05:54Z
...
## Свежесть этапов
- Stage53 screener: **STALE** | age 44.53h | limit 30.0h
...
- Stage57 international: **OK** | age 20.31h | limit 30.0h
...
- Stage71 challengers: **STALE** | age 11.59h | limit 8.0h
...
## Проблемы
- **WARN** `STALE_STAGE` — Stage53 screener: age 44.53h > 30.00h
- **WARN** `STALE_STAGE` — Stage71 challengers: age 11.59h > 8.00h
