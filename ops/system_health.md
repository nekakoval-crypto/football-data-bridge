...
Обновлено UTC: 2026-09-14T03:06:27Z
Статус: 🟠 **WARN** | critical 0 | warnings 5
...
## Свежесть этапов
- Stage53 screener: **OK** | age 14.30h | limit 30.0h
...
- Stage57 international: **OK** | age 20.35h | limit 30.0h
...
- Stage71 challengers: **OK** | age 3.63h | limit 8.0h
- Stage71C team totals: **STALE** | age 8.42h | limit 8.0h
- Stage71E double chance: **STALE** | age 8.42h | limit 8.0h
- Stage71F European handicap: **STALE** | age 8.42h | limit 8.0h
- Stage71G DNB: **STALE** | age 8.42h | limit 8.0h
...
## Проблемы
- **WARN** `STALE_STAGE` — Stage71C team totals: age 8.42h > 8.00h
- **WARN** `STALE_STAGE` — Stage71E double chance: age 8.42h > 8.00h
- **WARN** `STALE_STAGE` — Stage71F European handicap: age 8.42h > 8.00h
- **WARN** `STALE_STAGE` — Stage71G DNB: age 8.42h > 8.00h
