...
Обновлено UTC: 2026-09-25T22:05:49Z
...
## Свежесть этапов
- Stage53 screener: **OK** | age 15.52h | limit 30.0h
...
- Stage57 international: **OK** | age 15.30h | limit 30.0h
- Stage58 daily brief: **OK** | age 0.05h | limit 3.0h
- Stage59 user execution: **STALE** | age 10.20h | limit 3.0h
...
- Stage71 challengers: **STALE** | age 14.53h | limit 8.0h
...
## Проблемы
- **CRITICAL** `STALE_STAGE` — Stage59 user execution: age 10.20h > 3.00h
- **WARN** `STALE_STAGE` — Stage71 challengers: age 14.53h > 8.00h
